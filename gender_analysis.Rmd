...
```{r}
gender_regression_3 <- glm.nb(summary_count ~ gender_updated,  data = power_victoria_merged_filtered)
summary(gender_regression_3)

gender_regression_4 <- lm(total_moderate ~ gender_updated, data = summary_power_victoria_merged_filtered)
summary(gender_regression_4)
```

##AAA Support
```{r}
table(victoria_small_merged_1$aaa_bike_more_1, victoria_small_merged_1$gender_updated)
CrossTable(victoria_small_merged_1$aaa_bike_more_1, victoria_small_merged_1$gender_updated)
CrossTable(victoria_small_merged_1$aaa_familiarity_1, victoria_small_merged_1$gender_updated)
CrossTable(victoria_small_merged_1$aaa_idea_1, victoria_small_merged_1$gender_updated)
```
