...
power_victoria_merged <- left_join(table_of_power_merged_2, victoria_small_merged, by = "interact_id")

power_victoria_merged_1 <- left_join(table_of_power_merged_4, victoria_small_merged, by = "interact_id")
```
