...
```{r}
table_of_power <- fread("victoria_top_minute.csv")
...
power_victoria_merged <- full_join(table_of_power_merged_2, victoria_small_merged, by = "interact_id")
write_csv(power_victoria_merged, "power_victoria_merged.csv")
summary_power_victoria_merged <- full_join(table_of_power_merged_4, victoria_small_merged, by = "interact_id")
